...
def main():
    ...
    # Crea instancia del DataLoader y cargar/validar datos
    ...
    # Crea y ejecutar el modelo de optimización
    ...
    # Genera gráficos con ResultsHandler (asumiendo que toma resultados y parámetros)
    ...
    # Imprime resultados con formato
